...
You can drag it around by clicking and holding on any part of the window (exept "X" button). Window is not resizable. It also might look weird on Linux/Mac if they count coordinats diffirently from Windows.  

You can close it by pressing "X" button at the top-right corner.
